...
required_tools:
recommended_tools: chat_with_requester,keep_reasoning,exec
forbidden_tools:
script_mode: none
---
...
- Core Agent should choose among:
  - `chat_with_requester` for questions/validation
  - `keep_reasoning` for internal synthesis
